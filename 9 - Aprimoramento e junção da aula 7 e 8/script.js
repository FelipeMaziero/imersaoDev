...
function jogar() {
  ...
  if (cartas.length == 0) {
    ...
    if (pontosJogador > pontosMaquina) {
      htmlResultado = "<p class='resultado-final'>Parabéns você Venceu"
    } else if (pontosMaquina > pontosJogador) {
      htmlResultado = "<p class='resultado-final'>Infelizmente você perdeu"
    } else {
      htmlResultado = "<p class='resultado-final'>Empatou"
    }
  } else {
...
function proximaRodada() {
  ...
  //   var divPlacar = document.getElementById('placar')
  //   if (pontosJogador > pontosMaquina){
  //     var html = "Parabéns você venceu o jogo!!. A pontuação foi de: " + pontosJogador + " / " + pontosMaquina 
  //   } else if (pontosJogador < pontosMaquina) {
  //     var html = "Infelizmente você perdeu o jogo!!. A pontuação foi de: " + pontosJogador + " / " + pontosMaquina 
  //   } 
  //   divPlacar.innerHTML = html} else
  var divCartas = document.getElementById('cartas')
